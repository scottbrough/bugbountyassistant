...
class PlatformIntegration:
    ...
    def _process_hackerone_stats(self, data):
...
"""
        ...
        return {
            ...
            'scope_id': self._find_scope_id(primary_finding.get('url') or '', program_info),
    ...
    def _find_scope_id(self, url: str, program_info: Dict) -> str:
        url = url or ''
