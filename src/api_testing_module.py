...
import asyncio
import aiohttp
from jose import jwt  # Use python-jose for JWT operations
...
class APITester:
    ...
    def _create_jwt_weak_secret(self, secret: str) -> Optional[Dict]:
        ...
        try:
            ...
            # Ensure jwt.encode is available (PyJWT or fallback)
            try:
    ...
    def test_api_endpoints(self, base_url: str, endpoints: Optional[List[str]] = None) -> List[Dict]:
